...
def test_getAvailableLocationsRequest_successful(authorized_client):
    ...
    res = authorized_client.post('/api/ppc', data=xml_body, content_type='text/xml', headers=authorized_client.headers)
...
def test_getDecorationColorsRequest_successful(authorized_client):
...
def test_getFobPointsRequest_successful(authorized_client):
...
def test_getAvailableChargesRequest_successful(authorized_client):
...
def test_getConfigurationAndPricingRequest_successful(authorized_client):
...
def test_getAvailableLocationsRequest_validator(authorized_client, ws_version, id, password,
...
def test_getDecorationColorsRequest_validator(authorized_client, ws_version, id, password,
...
def test_getFobPointsRequest_validator(authorized_client, ws_version, id, password,
    product_id, localization_country, localization_language, status_code):
...
def test_getAvailableChargeRequest_validator(authorized_client, ws_version, id, password,
    product_id, localization_country, localization_language, status_code):
...
def test_getConfigurationAndPricingRequest_validator(authorized_client, ws_version, id, password,
